        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-3 ml-auto">
            <select
              ...
              className="px-4 py-2.5 border border-border rounded-xl text-sm bg-white"
            >
            ...
            <button
              ...
              disabled={isLoading}
              className="px-5 py-2.5 gradient-bg text-white rounded-xl text-sm font-semibold hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity shadow-sm"
            >
              {isLoading ? (
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  {rec.potentialSavings && (
                    <div className="text-right shrink-0 bg-success-light px-4 py-3 rounded-xl">
